...
png(filename = "./E-MTAB-2600_ERR523100_ERR522921_corr.png",height = 1000,width=1000,res = 150)
p21 <- ggplot(mm10_EMTAB_2600_FPKM_mereged,aes(x=log10(ERR523100), y=log10(ERR522921)))
...
p21 <- p21 + labs(x = "log10(ERR523100)", y = "log10(ERR522921)")
p21 <- p21 + theme(
