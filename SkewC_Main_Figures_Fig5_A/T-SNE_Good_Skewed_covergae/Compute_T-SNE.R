## 20190530
## Compute t-SNE from E-MTAB-2600 count table
...
###
library(dplyr)
mm10_EMTAB_2600_count_mereged_TSNE_DDDD <- mm10_EMTAB_2600_count_mereged_TSNE %>% select(one_of(as.character(rownames(E_MTAB_2600_columnAnnotation))))
