high_high_cor <-
  round(cor(
    mm10_EMTAB_2600_FPKM_mereged$ERR1211268,
    mm10_EMTAB_2600_FPKM_mereged$ERR1211204,
    method = "pearson"),2)

png(filename = "./E-MTAB-2600_ERR1211471_ERR1211638_corr.png",height = 1000,width=1000,res = 150)
p21 <- ggplot(mm10_EMTAB_2600_FPKM_mereged,aes(x=log10(ERR1211471), y=log10(ERR1211638)))
...
p21 <- p21 + labs(x = "log10(ERR1211471)", y = "log10(ERR1211638)")
p21 <- p21 + theme(
...
p21 <- p21 + ggtitle(paste0("EMTAB_2600: Expression correlation\nhigh-high coverage cells pearson correlation= ",high_high_cor))+
