...
housekeepingGenesx <- subset(mm9_PRJDB5282_TPM_mereged,Gene=='Gapdh' | Gene=='Actb' | Gene=='Hprt'
...
png(filename = "HouseKeepingGenes/PRJDB5282.png", width = 700,height = 700,res = 100)
q
dev.off()
