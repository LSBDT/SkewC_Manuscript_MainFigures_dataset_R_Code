...
## Perform apoptosis analysis on GSE46980 live cells
...
library(dplyr)
GSE46980Coverage_means_DF_R1_Live_cells <- subset(GSE46980Coverage_means_DF,Annotation %in% GSE46980_R1_Metadata_LIVE_cells$x)
GSE46980Coverage_means_DF_R1_Live_cells_melted  <-  melt(GSE46980Coverage_means_DF_R1_Live_cells,id=c("Annotation"))
write.table(GSE46980Coverage_means_DF_R1_Live_cells$Annotation,file = "GSE46980_live_cells.tsv",sep = "\t",col.names = F,row.names = F,quote = F)
## reanme annoation column values
GSE46980Coverage_means_DF_R1_Live_cells_melted[1:870,1] <- "GSE46980"

```

## Plotting of the mean coveage graph
```{r plotting}
GSE46980Coverage_means_DF_R1_Live_cells_melted_tgc <-
  summarySE(GSE46980Coverage_means_DF_R1_Live_cells_melted,measurevar = "value",groupvars =c("Annotation","variable"))
GSE46980Coverage_means_DF_R1_Live_cells_melted_pd <-
 # position_dodge(0.1) # move them .05 to the left and right
png(filename = "./GSE46980_mean_cov_R1_live_cells.png",width = 400,height = 400,res = 70)
 meanPlot <- ggplot(GSE46980Coverage_means_DF_R1_Live_cells_melted_tgc, aes(x=variable, y=value)) +
...
meanPlot =meanPlot+ geom_point(aes(group=1), size=2, shape=21, fill="white") + 
  ...
  labs(title ="mES |GSE46980|STRT|live cells (n=87)")
...
png(
  "./GSE46980_full_cov-R1_livecells.png",
  width = 400,
  height = 400,
  res = 70
  )
 ...
 SRR1043197,col.axis="black",font.axis=2,
  type = 'l',col= color,
 main = list("mES|GSE46980|STRT|live cells(n=87)",cex=1.5,col = "black",font=2),
